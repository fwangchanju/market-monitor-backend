...
public enum ErrorCode {
    ...
    SNAPSHOT_RETENTION_FAILED("스냅샷 정리 배치 실행에 실패했습니다."),
    ...
    // Market map
    SECTOR_TREE_SERIALIZE_FAILED("섹터 트리 직렬화에 실패했습니다."),
    SECTOR_TREE_PARSE_FAILED("섹터 스냅샷 파싱에 실패했습니다."),
    SECTOR_NOT_FOUND("이미 삭제되었거나 존재하지 않는 섹터입니다."),
